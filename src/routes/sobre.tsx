        ...
        <div>
          ...
          <ul className="mt-6 space-y-3 text-sm">
            <li className="flex items-center gap-2">
              <Heart className="h-4 w-4 text-primary" /> Curadoria semanal de novidades
            </li>
            <li className="flex items-center gap-2">
              <MessageCircle className="h-4 w-4 text-primary" /> Consultoria de estilo no WhatsApp
            </li>
            <li className="flex items-center gap-2">
              <MapPin className="h-4 w-4 text-primary" /> Loja física em {STORE_INFO.city}/{STORE_INFO.region}
            </li>
            <li className="flex items-center gap-2">
              <Clock className="h-4 w-4 text-primary" /> Seg a Sex · 10h às 19h
            </li>
          </ul>
          <a
            href={wa}
            ...
            className="mt-7 inline-flex items-center gap-2 bg-[#25D366] text-white px-6 py-3 rounded-full font-semibold"
          >
        ...
        <div className="max-w-[1200px] mx-auto px-6 grid md:grid-cols-2 gap-10 items-center">
          <div className="order-2 md:order-1">
            ...
            <p className="text-muted-foreground">
              CEP {STORE_INFO.postalCode} · Tel {STORE_INFO.phone}
            </p>
          </div>
